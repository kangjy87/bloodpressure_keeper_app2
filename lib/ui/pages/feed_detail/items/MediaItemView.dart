...
import 'package:bloodpressure_keeper_app/ui/pages/feed/enums.dart';
...
class MediaItemView extends StatelessWidget {
  ...
  Widget _getMediaItemView (ArticleMediaItemDto item, String platform) {
    ...
    switch (enumFromString(MediaType.values, item.type!)) {
      ...
      case MediaType.video :
        ...
        } else if (enumFromString(SnsType.values, platform) == SnsType.instagram) {
